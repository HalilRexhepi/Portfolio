...
<body class="is-preload">
	...
	<!-- Header -->
	<?php
		if(isset($_SESSION['add_contwo_message'])){ ?>
			<div style="text-align:center; width:50%; padding:1.5rem; background-color:gainsboro; margin:auto; left:0; top:0">
				<?php
					echo $_SESSION['add_contwo_message'];
				?>
			</div>
	<?php } ?>
	...
	<div class="table-wrapper">
		...
		OR contwo_description LIKE '%" . $term . "%'");
					...
					$sql = mysqli_query($conn, "SELECT * FROM containertwo");
				}
